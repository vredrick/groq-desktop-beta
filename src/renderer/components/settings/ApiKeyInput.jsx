...
function ApiKeyInput({ id, name, value, showApiKey, setShowApiKey, onChange, placeholder }) {
  return (
    <div className="relative">
      ...
      >
        {showApiKey ? (
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-text-tertiary" viewBox="0 0 20 20" fill="currentColor">
